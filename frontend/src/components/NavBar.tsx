        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              <li
                ref={dropdownRef}
                onClick={(e) => navigateFromDropdown(e, "/")}
              >
                <a>Strona Główna</a>
              </li>
              <li
                ref={dropdownRef}
                onClick={(e) => navigateFromDropdown(e, "/events")}
              >
                <a>Wydarzenia</a>
              </li>
              {user && (
                <li
                  ref={dropdownRef}
                  onClick={(e) => navigateFromDropdown(e, "/tickets")}
                >
                  <a>Bilety</a>
                </li>
              )}
              {user && (
                <li
                  ref={dropdownRef}
                  onClick={(e) => navigateFromDropdown(e, "/new-event")}
                >
